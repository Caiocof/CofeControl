...
<article class="home_featured">
    ...
    <div class="home_featured_app">
        <img src="<?= theme("/assets/images/home-app.jpg"); ?>" alt="NOME DA EMPRESA" title="NOME DA EMPRESA"/>
    </div>
</article>
...
<div class="home_features">
    <section class="container content">
        <header class="home_features_header">
            <h2>O que você pode fazer com o NOME DA EMPRESA?</h2>
...
<article class="home_optin">
    <div class="home_optin_content container content">
        <header class="home_optin_content_flex">
            <h2>Cadastre-se no NOME DA EMPRESA e comece a controlar suas contas hoje mesmo</h2>
            <p>Receber e pagar é uma tarefa comum do dia a dia, o NOME DA EMPRESA é um gerenciador de contas simples, fácil
...
<article class="home_video">
    <div class="home_video_content container content">
        <header>
            <h2>Descubra o NOME DA EMPRESA</h2>
