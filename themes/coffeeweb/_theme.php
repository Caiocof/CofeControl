...
<header class="main_header gradient gradient-green">
    <div class="container">
        <div class="main_header_logo">
            <h1><a class="icon-coffee transition" title="Home" href="<?= url(); ?>">NOME<b>DA EMPRESA</b></a></h1>
        </div>
    ...
    <div class="container content">
        <section class="main_footer_content">
            <article class="main_footer_content_item">
                <h2>Sobre:</h2>
                <p>NOME DA EMPRESA é um gerenciador de contas simples, poderoso e gratuito. O prazer de tomar um café e
            ...
            <article class="main_footer_content_item">
                ...
                <p class="icon-envelope"><b>Email:</b><br> EMAIL@DAEMPRESA.com</p>
                <p class="icon-map-marker"><b>Endereço:</b><br></p>
            </article>
