            ...
            <aside class="social_share">
                ...
                <div class="social_share_medias">
                    ...
                    <div class="fb-share-button"
                         data-href="<?= url("/post/{$post->uro}"); ?>"
                         data-layout="button_count"
                         data-size="large"
                         data-mobile-iframe="true">
                        <a target="_blank"
                           href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode(url("/post/{$post->uro}")); ?>"
                    ...
                    <a target="_blank"
                       ...
                       href="https://twitter.com/share?ref_src=site"
                       data-size="large"
                       data-text="<?= $post->title; ?>" data-url="<?= url("/post/{$post->uro}"); ?>"
